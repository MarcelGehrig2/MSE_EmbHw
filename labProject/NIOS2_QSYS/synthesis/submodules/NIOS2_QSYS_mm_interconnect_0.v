// NIOS2_QSYS_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module NIOS2_QSYS_mm_interconnect_0 (
	...
	wire  [101:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> sysid_control_slave_agent:cp_data
	...
	wire  [102:0] cpu_jtag_debug_module_agent_rf_source_data;                                // CPU_jtag_debug_module_agent:rf_source_data -> CPU_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [102:0] cpu_jtag_debug_module_agent_rsp_fifo_out_data;                             // CPU_jtag_debug_module_agent_rsp_fifo:out_data -> CPU_jtag_debug_module_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> CPU_jtag_debug_module_agent:cp_data
	...
	wire   [25:0] pll_pll_slave_agent_m0_address;                                            // PLL_pll_slave_agent:m0_address -> PLL_pll_slave_translator:uav_address
	...
	wire  [101:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> PLL_pll_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                     // PLL_pll_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> PLL_pll_slave_agent:cp_channel
	...
	wire   [25:0] sdram_ctrl_s1_agent_m0_address;                                            // SDRAM_ctrl_s1_agent:m0_address -> SDRAM_ctrl_s1_translator:uav_address
	...
	wire   [84:0] sdram_ctrl_s1_agent_rf_source_data;                                        // SDRAM_ctrl_s1_agent:rf_source_data -> SDRAM_ctrl_s1_agent_rsp_fifo:in_data
	...
	wire   [84:0] sdram_ctrl_s1_agent_rsp_fifo_out_data;                                     // SDRAM_ctrl_s1_agent_rsp_fifo:out_data -> SDRAM_ctrl_s1_agent:rf_sink_data
	...
	wire  [102:0] leds_s1_agent_rf_source_data;                                              // LEDs_s1_agent:rf_source_data -> LEDs_s1_agent_rsp_fifo:in_data
	...
	wire  [102:0] leds_s1_agent_rsp_fifo_out_data;                                           // LEDs_s1_agent_rsp_fifo:out_data -> LEDs_s1_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> LEDs_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                     // LEDs_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> LEDs_s1_agent:cp_channel
	...
	wire  [101:0] cpu_data_master_agent_cp_data;                                             // CPU_data_master_agent:cp_data -> router:sink_data
	...
	wire  [101:0] cpu_instruction_master_agent_cp_data;                                      // CPU_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [101:0] sysid_control_slave_agent_rp_data;                                         // sysid_control_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [101:0] cpu_jtag_debug_module_agent_rp_data;                                       // CPU_jtag_debug_module_agent:rp_data -> router_004:sink_data
	...
	wire  [101:0] pll_pll_slave_agent_rp_data;                                               // PLL_pll_slave_agent:rp_data -> router_005:sink_data
	...
	wire          sdram_ctrl_s1_agent_rp_valid;                                              // SDRAM_ctrl_s1_agent:rp_valid -> router_006:sink_valid
	wire   [83:0] sdram_ctrl_s1_agent_rp_data;                                               // SDRAM_ctrl_s1_agent:rp_data -> router_006:sink_data
	wire          sdram_ctrl_s1_agent_rp_ready;                                              // router_006:sink_ready -> SDRAM_ctrl_s1_agent:rp_ready
	wire          sdram_ctrl_s1_agent_rp_startofpacket;                                      // SDRAM_ctrl_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          sdram_ctrl_s1_agent_rp_endofpacket;                                        // SDRAM_ctrl_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	wire          leds_s1_agent_rp_valid;                                                    // LEDs_s1_agent:rp_valid -> router_007:sink_valid
	wire  [101:0] leds_s1_agent_rp_data;                                                     // LEDs_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [101:0] router_src_data;                                                           // router:src_data -> CPU_data_master_limiter:cmd_sink_data
	...
	wire  [101:0] cpu_data_master_limiter_cmd_src_data;                                      // CPU_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [101:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> CPU_data_master_limiter:rsp_sink_data
	...
	wire  [101:0] cpu_data_master_limiter_rsp_src_data;                                      // CPU_data_master_limiter:rsp_src_data -> CPU_data_master_agent:rp_data
	...
	wire  [101:0] router_001_src_data;                                                       // router_001:src_data -> CPU_instruction_master_limiter:cmd_sink_data
	...
	wire  [101:0] cpu_instruction_master_limiter_cmd_src_data;                               // CPU_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [101:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> CPU_instruction_master_limiter:rsp_sink_data
	...
	wire  [101:0] cpu_instruction_master_limiter_rsp_src_data;                               // CPU_instruction_master_limiter:rsp_src_data -> CPU_instruction_master_agent:rp_data
	...
	wire   [83:0] sdram_ctrl_s1_burst_adapter_source0_data;                                  // SDRAM_ctrl_s1_burst_adapter:source0_data -> SDRAM_ctrl_s1_agent:cp_data
	wire          sdram_ctrl_s1_burst_adapter_source0_ready;                                 // SDRAM_ctrl_s1_agent:cp_ready -> SDRAM_ctrl_s1_burst_adapter:source0_ready
	wire    [5:0] sdram_ctrl_s1_burst_adapter_source0_channel;                               // SDRAM_ctrl_s1_burst_adapter:source0_channel -> SDRAM_ctrl_s1_agent:cp_channel
	...
	wire          router_006_src_valid;                                                      // router_006:src_valid -> SDRAM_ctrl_s1_rsp_width_adapter:in_valid
	wire   [83:0] router_006_src_data;                                                       // router_006:src_data -> SDRAM_ctrl_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                      // SDRAM_ctrl_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [5:0] router_006_src_channel;                                                    // router_006:src_channel -> SDRAM_ctrl_s1_rsp_width_adapter:in_channel
	wire          router_006_src_startofpacket;                                              // router_006:src_startofpacket -> SDRAM_ctrl_s1_rsp_width_adapter:in_startofpacket
	wire          router_006_src_endofpacket;                                                // router_006:src_endofpacket -> SDRAM_ctrl_s1_rsp_width_adapter:in_endofpacket
	wire          sdram_ctrl_s1_rsp_width_adapter_src_valid;                                 // SDRAM_ctrl_s1_rsp_width_adapter:out_valid -> rsp_demux_004:sink_valid
	wire  [101:0] sdram_ctrl_s1_rsp_width_adapter_src_data;                                  // SDRAM_ctrl_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          sdram_ctrl_s1_rsp_width_adapter_src_ready;                                 // rsp_demux_004:sink_ready -> SDRAM_ctrl_s1_rsp_width_adapter:out_ready
	wire    [5:0] sdram_ctrl_s1_rsp_width_adapter_src_channel;                               // SDRAM_ctrl_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	...
	wire  [101:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> SDRAM_ctrl_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                     // SDRAM_ctrl_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> SDRAM_ctrl_s1_cmd_width_adapter:in_channel
	...
	wire   [83:0] sdram_ctrl_s1_cmd_width_adapter_src_data;                                  // SDRAM_ctrl_s1_cmd_width_adapter:out_data -> SDRAM_ctrl_s1_burst_adapter:sink0_data
	...
	wire    [5:0] sdram_ctrl_s1_cmd_width_adapter_src_channel;                               // SDRAM_ctrl_s1_cmd_width_adapter:out_channel -> SDRAM_ctrl_s1_burst_adapter:sink0_channel
	...
	wire  [101:0] cmd_demux_src3_data;                                                       // cmd_demux:src3_data -> crosser:in_data
	...
	wire  [101:0] crosser_out_data;                                                          // crosser:out_data -> cmd_mux_003:sink0_data
	...
	wire  [101:0] rsp_demux_003_src0_data;                                                   // rsp_demux_003:src0_data -> crosser_001:in_data
	wire          rsp_demux_003_src0_ready;                                                  // crosser_001:in_ready -> rsp_demux_003:src0_ready
	wire    [5:0] rsp_demux_003_src0_channel;                                                // rsp_demux_003:src0_channel -> crosser_001:in_channel
	...
	wire  [101:0] crosser_001_out_data;                                                      // crosser_001:out_data -> rsp_mux:sink3_data
	wire          crosser_001_out_ready;                                                     // rsp_mux:sink3_ready -> crosser_001:out_ready
	wire    [5:0] crosser_001_out_channel;                                                   // crosser_001:out_channel -> rsp_mux:sink3_channel
	...
	NIOS2_QSYS_mm_interconnect_0_router router (
	...
	NIOS2_QSYS_mm_interconnect_0_router_001 router_001 (
	...
	NIOS2_QSYS_mm_interconnect_0_router_002 router_002 (
	...
	NIOS2_QSYS_mm_interconnect_0_router_002 router_003 (
	...
	NIOS2_QSYS_mm_interconnect_0_router_004 router_004 (
	...
	NIOS2_QSYS_mm_interconnect_0_router_002 router_005 (
	...
	NIOS2_QSYS_mm_interconnect_0_router_006 router_006 (
	...
	NIOS2_QSYS_mm_interconnect_0_router_002 router_007 (
	...
	NIOS2_QSYS_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (PLL_c0_clk),                                    //        clk.clk
		.reset              (CPU_reset_n_reset_bridge_in_reset_reset),       //  clk_reset.reset
	...
	NIOS2_QSYS_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (PLL_c0_clk),                                           //        clk.clk
		.reset              (CPU_reset_n_reset_bridge_in_reset_reset),              //  clk_reset.reset
	...
	NIOS2_QSYS_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (PLL_c0_clk),                              //       clk.clk
		.reset               (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS2_QSYS_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (PLL_c0_clk),                              //       clk.clk
		.reset               (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS2_QSYS_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (PLL_c0_clk),                              //       clk.clk
		.reset               (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS2_QSYS_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                         //       clk.clk
		.reset               (PLL_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS2_QSYS_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (PLL_c0_clk),                              //       clk.clk
		.reset               (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS2_QSYS_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (PLL_c0_clk),                              //       clk.clk
		.reset               (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS2_QSYS_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (PLL_c0_clk),                              //       clk.clk
		.reset              (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS2_QSYS_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (PLL_c0_clk),                              //       clk.clk
		.reset              (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS2_QSYS_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (PLL_c0_clk),                              //       clk.clk
		.reset              (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS2_QSYS_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                         //       clk.clk
		.reset              (PLL_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS2_QSYS_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (PLL_c0_clk),                                        //       clk.clk
		.reset              (CPU_reset_n_reset_bridge_in_reset_reset),           // clk_reset.reset
	...
	NIOS2_QSYS_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (PLL_c0_clk),                              //       clk.clk
		.reset              (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS2_QSYS_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (PLL_c0_clk),                              //       clk.clk
		.reset               (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS2_QSYS_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (PLL_c0_clk),                              //       clk.clk
		.reset               (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS2_QSYS_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	NIOS2_QSYS_mm_interconnect_0_avalon_st_adapter_004 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),

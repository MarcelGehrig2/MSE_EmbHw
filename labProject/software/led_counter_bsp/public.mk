...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../NIOS2_QSYS.sopcinfo
...
# Design Name 
# setting SOPC_NAME is NIOS2_QSYS
SOPC_NAME := NIOS2_QSYS
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2001020
SOPC_SYSID_FLAG += --sidp=0x2001020
ELF_PATCH_FLAG  += --sidp 0x2001020

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1460037355
SOPC_SYSID_FLAG += --timestamp=1460037355
ELF_PATCH_FLAG  += --timestamp 1460037355

...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../mse_demo.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../base_system.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1001158
SOPC_SYSID_FLAG += --sidp=0x1001158
ELF_PATCH_FLAG  += --sidp 0x1001158

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1462443778
SOPC_SYSID_FLAG += --timestamp=1462443778
ELF_PATCH_FLAG  += --timestamp 1462443778

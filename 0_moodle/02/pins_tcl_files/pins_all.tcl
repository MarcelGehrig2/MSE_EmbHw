...
#### DIPSWITCHES
	 ...
	 set_location_assignment PIN_A11  -to SWITCHES[0]
	 set_location_assignment PIN_B12  -to SWITCHES[1]
	 set_location_assignment PIN_A12  -to SWITCHES[2]
	 set_location_assignment PIN_AA12  -to SWITCHES[3]
	 set_location_assignment PIN_AB12  -to SWITCHES[4]
	 set_location_assignment PIN_AA11  -to SWITCHES[5]
	 set_location_assignment PIN_AB11  -to SWITCHES[6]	 
